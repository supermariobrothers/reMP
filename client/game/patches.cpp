...
{	
	...
	*(BYTE*)0x551060 = 0x42; // 17096 from 13000
	...
	//Cursor hiding (disabled - breaks pause/settings menu mouse)
	//UnFuck(0x7481CD,16);
	...
	// A SetCursorPos proc internally (disabled - breaks cursor in settings)
	//UnFuck(0x6194A0,1);
	//*(PBYTE)0x6194A0 = 0xC3;
	...
	*(PBYTE)0x71162C = 80;
	...
	// Anti-pause (disabled - breaks CMenuManager::Process and ESC settings menu!)
	//UnFuck(0x561AF0,7);
	...
	*(BYTE*)0x411459 = 0x01;*/
	...
	// CPopulation::Update nulled (prevents ambient traffic/ped generation crash)
	UnFuck(0x616650,1);
	*(BYTE *)0x616650 = 0xC3;

	// CScriptsForBrains::CheckIfNewEntityNeedsScript nulled (ret 12 - prevents crash when called with null entity)
	UnFuck(0x46FF20,3);
	*(BYTE *)0x46FF20 = 0xC2;
	*(BYTE *)0x46FF21 = 0x0C;
	*(BYTE *)0x46FF22 = 0x00;
