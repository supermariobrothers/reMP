...
BOOL WINAPI DllMain(HINSTANCE hinstDLL, DWORD fdwReason, LPVOID lpvReserved)
{
	if(DLL_PROCESS_ATTACH==fdwReason)
	{
		...
		InitDebugLog();
		LogDebug("SA-MP Process Attached, Settings: Debug=%d, PlayOnline=%d, Host=%s:%s, Nick=%s",
			tSettings.bDebug, tSettings.bPlayOnline, tSettings.szConnectHost, tSettings.szConnectPort, tSettings.szNickName);
